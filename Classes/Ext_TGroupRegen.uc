...
{
	if( Perk.CurrentPrestige<1 || Perk.CurrentLevel<75 )
		return 1;
	if( Perk.CurrentPrestige<5 || Perk.CurrentLevel<125 )
		return 2;
	return ((Perk.CurrentPrestige<Perk.MaxPrestige || Perk.CurrentLevel<150) ? 3 : 4);
}
