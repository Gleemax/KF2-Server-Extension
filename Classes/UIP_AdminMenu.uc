...
defaultproperties
{
	Begin Object Class=KFGUI_RightClickMenu Name=PlayerContextMenu
		...
		ItemRows.Add((Text="Show Debug Info",Value=11))
		ItemRows.Add((bSplitter=true))
		ItemRows.Add((Text="Add 1,000 XP",Value=2))
		ItemRows.Add((Text="Add 10,000 XP",Value=3))
		ItemRows.Add((Text="Add 50,000 XP",Value=4))
		ItemRows.Add((Text="Advance Perk Level",Value=5))
		ItemRows.Add((Text="Set Perk Level",Value=-1))
		ItemRows.Add((Text="Set Prestige Level",Value=-2))
		ItemRows.Add((bSplitter=true))
		ItemRows.Add((Text="Unload all stats",Value=6))
		ItemRows.Add((Text="Unload all traits",Value=7))
		ItemRows.Add((bSplitter=true))
		ItemRows.Add((Text="Remove 1,000 XP",Value=8))
		ItemRows.Add((Text="Remove 10,000 XP",Value=9))
		ItemRows.Add((Text="Remove 50,000 XP",Value=10))
		ItemRows.Add((bSplitter=true))
