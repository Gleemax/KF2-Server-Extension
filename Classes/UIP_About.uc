...
defaultproperties
{
	...
	Begin Object Class=KFGUI_TextField Name=AboutText
		...
		XSize=0.95
		YSize=0.8
		Text="#{F3E2A9}Server Extension Mod#{DEF} - Written by Marco||Credits:|#{01DF3A}Forrest Mark X#{DEF} - Implementation of first person legs and backpack weapon.|Translation:|CORLEONE & DeathAngle|Mod Extened:|#{FF0000}DeathAngle#{DEF}#{FF00FF}Sheep#{DEF} - Beta testing.|Mysterial - For ideas from UT2004RPG mod.|All other beta testers..."
	End Object
